...
/**
 * Created by jie.xiao on 9/7/2015.
 */
...
//				Log.i(TAG, "pull up!parent view move!");
    ...
    public void onHeaderRefreshComplete() {
        ...
        mHeaderUpdateTextView.setText("最后更新："+df.format(System.currentTimeMillis()));
        mHeaderState = PULL_TO_REFRESH;
    }
...
//		mHeaderUpdateTextView.setText(df.format(System.currentTimeMillis()));
        mFooterState = PULL_TO_REFRESH;
    }
