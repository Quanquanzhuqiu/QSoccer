 ...
 */
public class MemberFeeListViewAdapter extends BaseAdapter {

    private Context context;
    public List<EntTeamMemberDTO> mList;
    private boolean isIncome;

    public MemberFeeListViewAdapter(Context context, List<EntTeamMemberDTO> mList, boolean isIncome) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(context).inflate(R.layout.item_lv_member_balance, null);
...
//            String logoUrl = entTeamMember.getLogoUrl();
            ...
            viewHolder.tv_team_balance.setText(balance);
        }
