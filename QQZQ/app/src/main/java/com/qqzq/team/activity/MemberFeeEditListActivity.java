...
import com.qqzq.team.adapter.MemberFeeEditListViewAdapter;
...
public class MemberFeeEditListActivity extends BaseActivity {
    ...
    private List<EntTeamMemberDTO> mList = new ArrayList<>();
    ...
    private void sendEditedMemberFee() {
        EntMemberBalanceInfoDTO entMemberBalanceInfo = new EntMemberBalanceInfoDTO();
        Map<Integer, Float> selectedData = adapter.getSelectedData();
        for (EntTeamMemberDTO entTeamMember : mList) {
